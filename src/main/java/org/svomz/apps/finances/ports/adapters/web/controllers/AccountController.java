...
import org.svomz.apps.finances.application.command.GetTransactionCategoriesForAccount;
...
public class AccountController {
  ...
  public String show(@PathVariable String accountId, Model model)
    ...
    model.addAttribute("account", this.accountSummaryQuery.execute(accountId))
      .addAttribute("transactions", this.listTransactionsQuery.execute(accountId, 1, 1000))
      .addAttribute("categories", this.getTransactionCategoriesForAccount.execute(accountId));
    return "account/show";
  }
